...
<div style="text-align: center; padding-top: 35px; margin-bottom: -35px; color: #abd7ff;">
    ...
    <img src="../../<?= $_SESSION['user']->avatar ?>" width="200" height="200" style="border-radius: 15px; margin-bottom: 50px">
</div>
<div id="index">
    <div class="card" id="index-body-lk">
        ...
        <form class="d-flex flex-column justify-content-center align-items-center"
              action="../../middleware/clients/createClient.php" method="post" style="text-align: center">
