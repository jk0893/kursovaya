...
?>
    ...
    <div class="container text-light">
            ...
            <div class="position-absolute top-50 end-50 d-flex flex-column justify-content-center align-items-center">
                ...
                <div>
                    <div class="mb-2">
                        ...
                        <input type="text" name="name" class="form-control" id="first_name" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" name="price" class="form-control" id="father_name" aria-describedby="emailHelp">
                    </div>
        ...
        if (isset($_POST['name'])) {
            require($_SERVER['DOCUMENT_ROOT'] . '/controllers/Services.php');
            $db = new Services();
            $data=$db->createUslugi(json_encode([
                'name' => $_POST['name'],
                'type' => $_POST['type'],
                'price' => $_POST['price']
            ]));
